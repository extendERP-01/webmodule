...
public class ExcelDebitLedgerReport extends AbstractXlsView {

	Logger logger = LoggerFactory.getLogger(ExcelDebitLedgerReport.class);
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		try {
			...
			List<DebitCreditLedgerModel> debitLedger = (List<DebitCreditLedgerModel>) model.get("debitLedger");
			HSSFSheet realSheet = ((HSSFWorkbook) workbook).createSheet("Debit Ledger Report");
