...
public class AttendanceExcelReport extends AbstractXlsView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		try {
			...
			List<HrmsAttendanceApprovalModel> accountLedger = (List<HrmsAttendanceApprovalModel>) model
					.get("consumption");
			...
			cell1.setCellValue("Redimix Attendance Details Excel");
			...
			int i = 1;
			int j = 1;
			for (HrmsAttendanceApprovalModel m : accountLedger) {
