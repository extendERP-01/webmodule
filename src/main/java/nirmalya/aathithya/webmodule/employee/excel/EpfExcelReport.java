...
public class EpfExcelReport extends AbstractXlsView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		try {
			...
			List<HrmsEpfExcelModel> accountLedger = (List<HrmsEpfExcelModel>) model.get("consumption");
			...
			cell1.setCellValue("Redimix Employee EPF Details");
			...
			int i = 2;
			int j = 1;
			for (HrmsEpfExcelModel m : accountLedger) {
				...
				cell = row.createCell(4);
				cell.setCellValue(m.getEmpl_Epf());

				cell = row.createCell(5);
				cell.setCellValue(m.getEmpr_Epf());
			...
			for (HrmsEpfExcelModel m : accountLedger) {
				...
				TESD_Empl_Epf = TESD_Empl_Epf + m.getEmpl_Epf();
				TESD_Empr_Epf = TESD_Empr_Epf + m.getEmpr_Epf();
