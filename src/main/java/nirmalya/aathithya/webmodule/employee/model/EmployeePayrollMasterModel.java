...
public class EmployeePayrollMasterModel {
	...
	private BigInteger totalAttendance;
	private Double otherChargeAdded;
	private Double otherChargeDeduct;
	private String paymentDate;
	private Double totalPaymentAmount;
	private String monthName;
	private Double totalWorkingDays;
	private Double employeWorkingDays;

	List<HrmsEmployeeSalaryComponentsModel> salaryComponentsDetails = new ArrayList<HrmsEmployeeSalaryComponentsModel>();
	...
	public BigInteger getTotalAttendance() {
		return totalAttendance;
	}

	public void setTotalAttendance(BigInteger totalAttendance) {
		this.totalAttendance = totalAttendance;
	}

	public Double getOtherChargeAdded() {
		return otherChargeAdded;
	}

	public void setOtherChargeAdded(Double otherChargeAdded) {
		this.otherChargeAdded = otherChargeAdded;
	}

	public Double getOtherChargeDeduct() {
		return otherChargeDeduct;
	}

	public void setOtherChargeDeduct(Double otherChargeDeduct) {
		this.otherChargeDeduct = otherChargeDeduct;
	}
	...
	public Double getEmployeWorkingDays() {
		return employeWorkingDays;
	}

	public void setEmployeWorkingDays(Double employeWorkingDays) {
		this.employeWorkingDays = employeWorkingDays;
	}

	public List<HrmsEmployeeSalaryComponentsModel> getSalaryComponentsDetails() {
		return salaryComponentsDetails;
	}

	public void setSalaryComponentsDetails(List<HrmsEmployeeSalaryComponentsModel> salaryComponentsDetails) {
		this.salaryComponentsDetails = salaryComponentsDetails;
	}
