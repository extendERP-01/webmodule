...
public class PlanningExcelReport extends AbstractXlsView{
	Logger logger = LoggerFactory.getLogger(PlanningExcelReport.class);
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		try {
			...
			List<ProductionSummaryDetailsModel> productionSummaryDetailsModeliList = (List<ProductionSummaryDetailsModel>) model
					.get("itemReqiList");
			HSSFSheet realSheet = ((HSSFWorkbook) workbook).createSheet("Planning Excel Report");
