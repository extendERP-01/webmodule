...
public class ProductionSummaryExcelDetails extends AbstractXlsView{

	Logger logger = LoggerFactory.getLogger(ProductionSummaryExcelDetails.class);
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		try {
			...
			List<ProductionSummaryDetailsModel> productionSummaryDetailsModeliList = (List<ProductionSummaryDetailsModel>) model.get("itemReqiList");
			...
			cell.setCellValue("Scrap Quantity");
