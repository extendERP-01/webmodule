...
public class AssetFuelConsumptionModel {
	...
	private String fhrValue;
	private String bhrValue;
	...
	public String getTankFullName() {
		return tankFullName;
	}

	public void setTankFullName(String tankFullName) {
		this.tankFullName = tankFullName;
	}
	...
	public String getFhrValue() {
		return fhrValue;
	}

	public void setFhrValue(String fhrValue) {
		this.fhrValue = fhrValue;
	}

	public String getBhrValue() {
		return bhrValue;
	}

	public void setBhrValue(String bhrValue) {
		this.bhrValue = bhrValue;
	}
