...
public class AssetPolicyMasterController {
	...
	public String addpolicyMaster(Model model, HttpSession session) {
		...
		try {
			DropDownModel[] serviceType = restClient.getForObject(env.getAssetUrl() + "getServiceTypeForPolicy",
					DropDownModel[].class);
			List<DropDownModel> serviceTypeList = Arrays.asList(serviceType);
...
System.out.println(index);
	...
	public @ResponseBody JsonResponse<Object> addAssetPolicy(@RequestBody List<AssetPolicyMaster> AssetPolicyMaster,
